...
ENV FAVORITE_TEAM_NICKNAME=Galo
ENV FAVORITE_TEAM_EMOJI=⚫🔴
ENV ATTACH_CRESTS=true
ENV MENTION_LISTENER=true
ENV MENTION_POLL_INTERVAL_MS=60000
ENV MENTION_COOLDOWN_MS=300000
